...
with st.sidebar:
    ...
    fecha_inicioo = st.date_input(min_value=datetime.date(2014,7,4), max_value=datetime.date20200883131
    st.write("hasta el")))
    fecha_fin = st.date_input(min_value=fecha_inicio, max_value=datetime.date(2020,8,31))
    st.write("tipo de accidente: ")
